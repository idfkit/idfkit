...
class TestOpaqueConstruction:
    ...
    def test_get_construction_layers(self, simple_wall) -> None:
    ...
    def test_layer_r_values(self, simple_wall) -> None:
        layers = get_construction_layers(simple_wall)
    ...
    def test_calculate_r_value_without_films(self, simple_wall) -> None:
    ...
    def test_calculate_r_value_with_films(self, simple_wall) -> None:
    ...
    def test_calculate_u_value(self, simple_wall) -> None:
        u = calculate_u_value(simple_wall)
        r = calculate_r_value(simple_wall, include_films=True)
        assert u == pytest.approx(1.0 / r, rel=0.01)

    def test_air_gap_resistance(self, wall_with_air_gap) -> None:
    ...
    def test_nomass_resistance(self, wall_with_nomass) -> None:
    ...
    def test_get_thermal_properties(self, simple_wall) -> None:
    ...
    def test_shgc_returns_none_for_opaque(self, simple_wall) -> None:
        shgc = calculate_shgc(simple_wall)
        assert shgc is None

    def test_visible_transmittance_returns_none_for_opaque(self, simple_wall) -> None:
...
class TestGlazingConstruction:
    ...
    def test_double_glazing_u_value(self, double_glazing) -> None:
    ...
    def test_get_thermal_properties_glazing(self, double_glazing) -> None:
