    ...
    def _make_box_model() -> IDFDocument:
        ...
        doc.add(
            ...
            "NorthWall",
            {
                ...
                "number_of_vertices": 4,
                "vertices": [
                    {"vertex_x_coordinate": 10, "vertex_y_coordinate": 10, "vertex_z_coordinate": 3},
                    ...
                    {"vertex_x_coordinate": 0, "vertex_y_coordinate": 10, "vertex_z_coordinate": 3},
                ],
            },
            validate=False,
        )
    ...
    def test_set_wwr_preserves_construction_name(self) -> None:
        ...
        doc.add(
            ...
            "SouthWall_Glz0",
            {
                ...
                "number_of_vertices": 4,
                "vertices": [
                    {"vertex_x_coordinate": 1, "vertex_y_coordinate": 0, "vertex_z_coordinate": 2.5},
                    {"vertex_x_coordinate": 1, "vertex_y_coordinate": 0, "vertex_z_coordinate": 0.5},
                    {"vertex_x_coordinate": 3, "vertex_y_coordinate": 0, "vertex_z_coordinate": 0.5},
                    {"vertex_x_coordinate": 3, "vertex_y_coordinate": 0, "vertex_z_coordinate": 2.5},
                ],
            },
            validate=False,
        )
        ...
        doc.add(
            ...
            "WallA",
            {
                ...
                "vertices": [
                    ...
                    {"vertex_x_coordinate": 0, "vertex_y_coordinate": 5, "vertex_z_coordinate": 0},
                    {"vertex_x_coordinate": 10, "vertex_y_coordinate": 5, "vertex_z_coordinate": 0},
                    {"vertex_x_coordinate": 10, "vertex_y_coordinate": 5, "vertex_z_coordinate": 3},
                ],
            },
            validate=False,
        )
    ...
    def test_no_match_for_non_coincident_walls(self) -> None:
        ...
        doc.add(
            ...
            "NorthWall",
            {
                ...
                "number_of_vertices": 4,
                "vertices": [
                    {"vertex_x_coordinate": 10, "vertex_y_coordinate": 20, "vertex_z_coordinate": 3},
                    {"vertex_x_coordinate": 10, "vertex_y_coordinate": 20, "vertex_z_coordinate": 0},
                    {"vertex_x_coordinate": 0, "vertex_y_coordinate": 20, "vertex_z_coordinate": 0},
                    {"vertex_x_coordinate": 0, "vertex_y_coordinate": 20, "vertex_z_coordinate": 3},
                ],
            },
            validate=False,
        )
