...
```python
--8<-- "agent_references/snippets/hvac-templates.py:quickstart"
```
...
```python
--8<-- "agent_references/snippets/hvac-templates.py:worked-example"
```
...
```python
--8<-- "agent_references/snippets/hvac-templates.py:expand-option1"
```
...
```python
--8<-- "agent_references/snippets/hvac-templates.py:expand-option2"
```
...
```python
--8<-- "agent_references/snippets/hvac-templates.py:expand-option3"
```
...
```python
--8<-- "agent_references/snippets/hvac-templates.py:enumerate"
```
...
!!! success "pick one approach per zone"
    ...
    ```python
    --8<-- "agent_references/snippets/hvac-templates.py:mistake-mix-good"
    ```
...
!!! success "let `simulate` expand for you"
    ...
    ```python
    --8<-- "agent_references/snippets/hvac-templates.py:mistake-simulate-good"
    ```
...
!!! success "capture the return value"
    ...
    ```python
    --8<-- "agent_references/snippets/hvac-templates.py:mistake-expand-good"
    ```
