...
```python
--8<-- "agent_references/snippets/thermal-properties.py:quickstart"
```

## Core API

```python
--8<-- "agent_references/snippets/thermal-properties.py:core-api"
```
...
```python
--8<-- "agent_references/snippets/thermal-properties.py:construction-layers"
```
...
```python
--8<-- "agent_references/snippets/thermal-properties.py:r-u-value"
```
...
```python
--8<-- "agent_references/snippets/thermal-properties.py:shgc-vt"
```
...
```python
--8<-- "agent_references/snippets/thermal-properties.py:summary"
```
...
```python
--8<-- "agent_references/snippets/thermal-properties.py:gas-gap"
```
...
```python
--8<-- "agent_references/snippets/thermal-properties.py:worked-example"
```
...
!!! success "fix one mode and stick to it"
    ...
    ```python
    --8<-- "agent_references/snippets/thermal-properties.py:mistake-films-good"
    ```
...
!!! success "branch on construction type or trust `None`"
    ...
    ```python
    --8<-- "agent_references/snippets/thermal-properties.py:mistake-shgc-good"
    ```
...
!!! success "operate on objects belonging to a `doc`"
    ...
    ```python
    --8<-- "agent_references/snippets/thermal-properties.py:mistake-doc-good"
    ```
