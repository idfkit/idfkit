...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:quickstart"
```
...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:strict-mode"
```

Drop to `strict=False` only as a tolerant fallback for legacy or noisy files:

```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:strict-false"
```
...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:strict-parsing"
```
...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:version"
```

Override the version when the file is missing or wrong:

```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:version-override"
```
...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:preserve"
```
...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:convert"
```

Or use the explicit converters:

```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:convert-explicit"
```
...
```python
--8<-- "agent_references/snippets/parsing-idf-epjson.py:bulk"
```
...
!!! success "keep strict mode on for authoring"
    ...
    ```python
    --8<-- "agent_references/snippets/parsing-idf-epjson.py:mistake-strict-good"
    ```
...
!!! success "explicitly migrate before loading"
    ...
    ```python
    --8<-- "agent_references/snippets/parsing-idf-epjson.py:mistake-version-good"
    ```
...
!!! success "pair load + save"
    ...
    ```python
    --8<-- "agent_references/snippets/parsing-idf-epjson.py:mistake-preserve-good"
    ```
