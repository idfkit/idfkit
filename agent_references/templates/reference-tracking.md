...
```python
--8<-- "agent_references/snippets/reference-tracking.py:quickstart"
```
...
```python
--8<-- "agent_references/snippets/reference-tracking.py:find-referencing"
```
...
```python
--8<-- "agent_references/snippets/reference-tracking.py:rename"
```
...
```python
--8<-- "agent_references/snippets/reference-tracking.py:find-references"
```
...
```python
--8<-- "agent_references/snippets/reference-tracking.py:dangling"
```
...
!!! success "set `.name` or call `doc.rename`"
    ...
    ```python
    --8<-- "agent_references/snippets/reference-tracking.py:mistake-name-good"
    ```
...
!!! success "set the field through the wrapper"
    ...
    ```python
    --8<-- "agent_references/snippets/reference-tracking.py:mistake-field-good"
    ```
...
!!! success "ask the graph"
    ...
    ```python
    --8<-- "agent_references/snippets/reference-tracking.py:mistake-count-good"
    ```
