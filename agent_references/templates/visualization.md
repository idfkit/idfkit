...
```python
--8<-- "agent_references/snippets/visualization.py:model-view-quickstart"
```

### Construction cross-section

```python
--8<-- "agent_references/snippets/visualization.py:construction-cross-section"
```
...
```python
--8<-- "agent_references/snippets/visualization.py:core-api"
```

## 3D model views

```python
--8<-- "agent_references/snippets/visualization.py:model-views"
```
...
```python
--8<-- "agent_references/snippets/visualization.py:floor-plans"
```
...
```python
--8<-- "agent_references/snippets/visualization.py:normals-view"
```
...
```python
--8<-- "agent_references/snippets/visualization.py:construction-svg"
```
...
```python
--8<-- "agent_references/snippets/visualization.py:jupyter-repr"
```
...
```python
--8<-- "agent_references/snippets/visualization.py:workflow"
```
...
!!! success "keep fenestration on for envelope studies"
    ...
    ```python
    --8<-- "agent_references/snippets/visualization.py:mistake-fenestration-good"
    ```
...
!!! success "operate on `Construction`"
    ...
    ```python
    --8<-- "agent_references/snippets/visualization.py:mistake-svg-good"
    ```
...
!!! success "drop opacity for interior visibility"
    ...
    ```python
    --8<-- "agent_references/snippets/visualization.py:mistake-opacity-good"
    ```
