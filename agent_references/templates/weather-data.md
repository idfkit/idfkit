...
```python
--8<-- "agent_references/snippets/weather-data.py:quickstart"
```

## Core API

```python
--8<-- "agent_references/snippets/weather-data.py:core-api"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:search-name"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:search-address"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:search-coords"
```

### By distance

```python
--8<-- "agent_references/snippets/weather-data.py:search-distance"
```

## Inspecting a station

```python
--8<-- "agent_references/snippets/weather-data.py:inspect"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:download"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:design-days-ashrae"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:design-days-lower"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:detect-location"
```
...
```python
--8<-- "agent_references/snippets/weather-data.py:refresh"
```
...
!!! success "sleep, or pre-compute"
    ...
    ```python
    --8<-- "agent_references/snippets/weather-data.py:mistake-geocode-good"
    ```
...
!!! success "apply design days first"
    ...
    ```python
    --8<-- "agent_references/snippets/weather-data.py:mistake-designday-good"
    ```
...
!!! success "key on `(wmo, source)` if you need uniqueness"
    ...
    ```python
    --8<-- "agent_references/snippets/weather-data.py:mistake-uniqueness-good"
    ```
